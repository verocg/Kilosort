...
/* orig maxFR (= 10000) was clipping with longer batch durations or high firing rates.
 * ...try 5x and see what happens
 */
const int  Nthreads = 1024,  NrankMax = 6, maxFR = 50000, nt0max=81, NchanMax = 17, nsizes = 5;
